...
async def main():
    url = "https://learn.microsoft.com/ko-kr/fabric/"
    max_depth = 1
    ...
    data_source = create_data_source(
        data_source_name="microsoft_fabric_document",
        created_by="your_nickname",
        description="test description",
        data_source_type=DataSourceType.URL.value,
    ...
    # 5. 유사도 검색
    query = "fabric sdk 사용법"
    result = collection.similarity_search(query=query, search_type=Similarity(k=1, search_kwargs={"search_type": "approximate_search"}))
